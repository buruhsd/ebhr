...
class OrderController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('permission:report-purchase-order');
    }
    ...
    {
        $data = ReceiptItems::select('id','receipt_id','unit_op_id','unit_id','unit_conversion','qty_op','qty', DB::raw('ROUND(qty / unit_conversion,1) as qty_conversion'))
            ->with(
