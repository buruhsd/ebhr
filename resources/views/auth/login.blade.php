                ...
                <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
                    ...
                    <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                        ...
                        <div class="login-form">
                            <!--begin::Form-->
                            <form class="form" method="POST" action="{{ route('login') }}" id="kt_login_singin_form" >
                                @csrf
                                <!--begin::Title-->
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0 @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email') }}" autocomplete="off" />
                                </div>
                                ...
                                <div class="pb-lg-0 pb-5">
                                    ...
                                    <span class="svg-icon svg-icon-md">
                                        <!--begin::Svg Icon | path:asset/media/svg/social-icons/google.svg-->
