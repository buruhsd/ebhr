        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    @endif
                    <th scope="col" class="text-center border-0">{{ __('invoices::invoice.product_status') }}</th>
                    ...
                    @endif
                    <th scope="col" class="text-right border-0 pr-0">{{ __('invoices::invoice.item_value') }}</th>
                </tr>
            </thead>
            <tbody>
                {{-- Items --}}
